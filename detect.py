            ...
            if len(det):
                ...
                for c in det[:, -1].unique():
                    ...
                    if (opt.detailed_log):
                        ...
                        strs = [
                            f"(x: {x1}, y: {y1}, width: {x2 - x1}, height: {y2 - y1}, conf: {conf:.2f}, cls: {cls})"
                            for x1, y1, x2, y2, conf, cls in class_det
                        ]
...
if __name__ == '__main__':
    ...
    parser.add_argument(
        '--detailed-log',
        action='store_true',
        help='print coords, size, condifence, and class of inference')
