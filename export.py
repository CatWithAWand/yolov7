...
if __name__ == '__main__':
    ...
    for k, m in model.named_modules():
        ...
        if isinstance(m,
                      models.common.Conv):  # assign export-friendly activations
    ...
    try:
        ...
        if bits < 32:
            ...
            ) == 'darwin':  # quantization only supported on macOS
            ...
            if opt.end2end:
                ...
                if opt.end2end and opt.max_wh is None:
                    ...
                    shapes = [
                        ...
                        opt.batch_size, opt.topk_all, opt.batch_size,
                        opt.topk_all
                    ]
                else:
                    output_names = ['output']
